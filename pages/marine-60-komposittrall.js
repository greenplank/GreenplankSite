...
import Imagecolor1 from "../assets/images/colors/marine_60/Beach-Grey.webp";
import Imagecolor2 from "../assets/images/colors/marine_60/Charcoal.webp";
import Imagecolor3 from "../assets/images/colors/marine_60/Chocolate.webp";
import Imagecolor4 from "../assets/images/colors/marine_60/Ipe.webp";
import Imagecolor5 from "../assets/images/colors/marine_60/Walnut.webp";
import Imagecolor6 from "../assets/images/colors/marine_60/Stone-Grey.webp";
...
<meta name="robots" content="index,follow" />
        <title>
          MARINE60™ massiv komposittrall designad för friluftsliv -
          GreenPlank.se
        </title>
        <meta
          name="title"
          content="MARINE60™ massiv komposittrall designad för friluftsliv - GreenPlank.se"
        />
        <meta
          name="description"
          content="MARINE 60™ komposittrall det professionella valet för kommersiella projekt.Det delikata naturinspirerade utseendet på Marine60 ™ komposittrall med en halkfri yta och vackra färger passar den skandinaviska estetiska stilen."
        />
    <link rel="canonical" href="https://www.greenplank.se/marine-60-komposittrall" />
      </Head>
      ...
      <Layout pageTitle="MARINE60™ massiv komposittrall">
        ...
        <StickyHeader />
        <PageHeader
          title="MARINE60™ massiv komposittrall"
          crumbTitle="MARINE60™ massiv komposittrall"
        />
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                          <div className="project-details">
                            ...
                            <strong>
                              tidlös elegans för högre krav – PVC-fri!
                            </strong>
                            <div class="et_pb_text_inner">
                              <div class="ce_text block">
                                <strong>
                                  Inspirerad av naturen och designad för
                                  friluftsliv hittar du MARINE 60™ -utegolv i
                                  komposit är vackert realistiska och mycket
                                  praktiska med en tidlös kvalitet.
                                </strong>
                                <p>
                                  Green Plank MARINE 60™ Komposittrall av
                                  naturfiber är inget vanligt däcktrall. Det
                                  delikata naturinspirerade utseendet på
                                  Marine60 ™ komposittrall med en halkfri yta
                                  och vackra färger passar den skandinaviska
                                  estetiska stilen. Med vändbara ribbade /
                                  räfflade borstade ytor, förbättrad
                                  glidmotstånd och långvarig prestanda, är vårt
                                  MARINE 60™ komposittrall det professionella
                                  valet för kommersiella projekt och bostadshus.
                                </p>
                                <p>
                                  Hög glidbeständig, fin, ribbad yta i europeisk
                                  stil bildar ett jämnt mönster och möjliggör
                                  bra dragkraft i våta områden som runt pooler,
                                  de är säkra att gå på med bara fötter. Precis
                                  som äkta träskivor kan vårt MARINE 60™
                                ...
                                <div>
                                  <ul>
                                    ...
                                    <li>
                                      ...
                                      Komplettera dina drömuteplatsdäck med våra
                                      täckbrädor och skydd – den perfekta
                                      matchen för din högpresterande MARINE 60™
                                      – Komposittrall.
                                    </li>
                                  </ul>
                                </div>
                                  ...
                                  <table width="100%">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left"> Marine -60 Gp7180</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                      ...
                                      <tr>
                                        ...
                                        <td align="left">
                                          IPE,Walnut,Storn Grey,Charcoal,Beach
                                          Grey
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left">
                                          halksäker ,räfflad yta på ena sidan
                                          och en plan yta på den andra.
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                      ...
                                      <tr>
                                        ...
                                        <td align="left">4800 x 150 x 22 mm</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                          <strong>vikt /st :</strong>
                                        </td>
                                        <td align="left">19,2 kg/st</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                          <strong>vikt/m2 :</strong>
                                        </td>
                                        <td align="left">26,0 /m2</td>
                                      </tr>
                                ...
                                <div className="row mt-60">
                                  <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={6} sm={3} lg={6}>
                                      <a
                                        target="_blank"
                                        href="/pdfs/Marine60™/marine-60-swedish.pdf"
                                        className="thm-btn"
                                      >
                                        installationsguide
                                      </a>
                                    ...
                                    <Grid item xs={8} sm={6} lg={8}>
                                      <a
                                        target="_blank"
                                        href="/pdfs/Marine60™/marine-60-swedish-with-aluminum-1.pdf"
                                        className="thm-btn"
                                      >
                        ...
                        <div className="col-12 mb-80">
                          ...
                          <hr />
                          <p className="mb-40">
                            Green Plank SMART ™ -täcknings tillbehör utvidgar
                            dina horisonter ytterligare, så att du kan bygga ut
                            ...
                            rörelser, ventilerade aluminium lister, trall
                            pedaler, balk, etc., här är alla trall delar du
                            behöver för att slutföra ditt SMART ™ trall projekt.
                          </p>
                        ...
                        <div className="col-12 mb-30 mt-80">
                          ...
                          <Grid container spacing={3}>
                            ...
                            <Grid item xs={6} sm={2}>
                              <a
                                target="_blank"
                                href="/pdfs/MarineJumbo/datablad-greenplank-komposittrall-marine-jumbo.pdf"
                              >
                                <img
                                  src={pdfimg5}
                                  className="img-fluid"
