...
import PageHeader from "../components/page-header-StaketModern";
...
<meta name="robots" content="index,follow" />
        <title>KompositStaket modern | NOVOFENCE Kompositstaket - GreenPlank.se</title>
        <meta name="title" content="KompositStaket modern | NOVOFENCE Kompositstaket - GreenPlank.se" />
        <meta name="description" content="NOVOFENCE ™ Horisontellt Kompositstaket Modern, Novofence™ Modern™ staket system är extremt mångsidigt subtilt tillägg i alla bostads- eller kommersiella utomhusområden." />
    <link rel="canonical" href="https://www.greenplank.se/komposit-staket-modern" />
      </Head>
    <Layout pageTitle="KompositStaket modern | NOVOFENCE Kompositstaket - GreenPlank.se">
      <HeaderTwo />
      <StickyHeader />
                  ...
                  <div className="container">
                    <div className="row">
                        ...
                        <div className="project-details">
                          ...
                          <div class="et_pb_text_inner">
                            <div class="ce_text block">
                              ...
                              <strong>En enkel att bygga utan underhåll, högkvalitativ, anpassad staket för att möta dina specifika behov. Den här moderna stilen lantstaket med liggande brädor skapar en fantastisk modern gräns till din egendom.</strong>
                              <p>
                      ...
                      <div className="col-12 mb-80">
                        <h3>Tillgängliga färger. (Kontakta oss för att veta
                            exakt kvantitet)</h3>
                        <hr />
                        <Grid container spacing={3}>
                          <Grid item xs={6} sm={2}>
