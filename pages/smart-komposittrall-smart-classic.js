                    ...
                    <div className="row">
                              ...
                              <div className="row mt-60">
                                ...
                                <Grid container spacing={3}>
                                  ...
                                  <Grid item xs={6} sm={3} lg={6}>
                                    <a target="_blank" href="https://storage.googleapis.com/greenplankdata1/smart-classic-deck-swedish.pdf" className="thm-btn"  >installationsguide</a>
                                  </Grid>
                                  <Grid item xs={8} sm={6} lg={8}>
                                    <a target="_blank" href="https://storage.googleapis.com/greenplankdata1/smart-classic-deck-swedish%20(1).pdf" className="thm-btn" >installation av aluminium</a>
                                  </Grid>
                                </Grid>
                              </div>
                            </div>
                      ...
                      <div className="col-12 mb-30 mt-80" >
                        ...
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={6} sm={2}>
                            <a target="_blank" href="https://storage.googleapis.com/greenplankdata1/smart-classic-deck-swedish.pdf">
                          ...
                          <Grid item xs={6} sm={2}>
                            <a target="_blank" href="https://storage.googleapis.com/greenplankdata1/smart-classic-deck-swedish%20(1).pdf">
