...
import PageHeader from "../components/page-header-Sapphire";
...
import Imagecolor1 from "../assets/images/products/innerPages/Komposittrall/sapphire/charcoal.webp";
import Imagecolor2 from "../assets/images/products/innerPages/Komposittrall/sapphire/teak.webp";
...
<meta name="robots" content="index,follow" />
        <title>Sapphire™ komposittrall | Balkong komposittrall - Greenplank.se  </title>
        <meta name="title" content="Sapphire™ komposittrall | Balkong komposittrall - Greenplank.se " />
        <meta name="description" content="SAPPHIRE™ komposittrall ett attraktivt alternativ till träbeläggningsmaterial. Sapphire™ komposittrall varit de bästsäljande däckbrädorna i mer än tio år och är fortfarande idag." />
    <link rel="canonical" href="https://www.greenplank.se/sapphire-komposittrall" />
      </Head>
    <Layout pageTitle="Sapphire™ komposittrall | Balkong komposittrall - Greenplank.se ">
      <HeaderTwo />
      <StickyHeader />
      <PageHeader
        title="Sapphire™ komposittrall med räfflor ger ett säreget utseende."
        crumbTitle="Sapphire™ komposittrall med räfflor ger ett säreget utseende."
      />
                  ...
                  <div className="container">
                    <div className="row">
                        ...
                        <div className="project-details">
                          ...
                          <div class="et_pb_text_inner">
                            <div class="ce_text block">
                              <strong>
                                Inspirerad av det traditionella trädäcket som
                                kännetecknas av estetik, hållbarhet och
                                funktionalitet.
                              </strong>
                              <p>
                                Med ett traditionellt trädekorations utseende
                                och lång livslängd är vårt SAPPHIRE™
                                komposittrall ett attraktivt alternativ till
                                träbeläggningsmaterial. Med ett så överraskande
                                prisvärt alternativ finns det helt enkelt ingen
                                anledning att nöja sig med färgning, tätning,
                                splinter och konstant underhåll.
                              </p>
                              <p>
                                Hög glidbeständiga eleganta, ribbade / räfflade
                                borstade ytor möjliggör bra dragkraft i våta
                                områden som runt pooler, de är säkra att gå på
                                barfota.
                              </p>
                              <p>
                                Med en estetisk skandinavisk designutseende har
                                vårt Sapphire™ -komposittrall varit de
                                bästsäljande däckbrädorna i mer än tio år och är
                                fortfarande idag.
                              </p>
                              <div>
                                <ul>
                                  ...
                                  <li>
                                    <strong>Enhetlighet </strong>– HidLo™ dolda
                                    fästelement säkerställer en slät och
                                  ...
                                  <li>
                                    ...
                                    högpresterande SAPPHIRE ™ – Komposittrall.
                                  </li>
                                </ul>
                              </div>
                            </div>
                                ...
                                <table width="100%">
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td align="left">
                                        Teak,Charcoal,Beach Grey, krämvit
                                      </td>
                                    </tr>
                                    <tr>
                                      <td align="left">
                                    ...
                                    <tr>
                                      ...
                                      <td align="left">Komposit Trall helga</td>
                                    </tr>
                                    <tr>
                                      <td align="left">
                                        <strong>Åtgång:</strong>
                                      </td>
                                      <td align="left">6,5 lm/m2</td>
                                    </tr>
                                    <tr>
                                      <td align="left">
                                        <strong>Antal/St :</strong>
                                      </td>
                                      <td align="left">0,74 /m2</td>
                                    </tr>
                                    <tr>
                                      <td align="left">
                                    ...
                                    <tr>
                                      ...
                                      <td align="left">4800 x 150 x 25 mm</td>
                                    </tr>
                                    <tr>
                                      <td align="left">
                                        <strong>vikt /st :</strong>
                                      </td>
                                      <td align="left">13,06 kg/st</td>
                                    </tr>
                                    <tr>
                                      <td align="left">
                                        <strong>vikt/m2 :</strong>
                                      </td>
                                      <td align="left">17,68 /m2</td>
                                    </tr>
                                    <tr>
                                      <td align="left">
                                        <strong>Material :</strong>
                                      </td>
                                      <td align="left">Trall komposit</td>
                                    </tr>
                                    <tr>
                                      <td align="left">
                          ...
                          <div className="row">
                            <div className="col-md-6 col-mobile-6 mb-40 mt-20 pl-30 pl-sm-15 pl-xs-15">
                              <div className="project-details">
                                ...
                                <h3>Färgval</h3>
                                <p>
                                  Studio fotografering och / eller din surfings
                                  enhet kanske inte ger en exakt bild av
                                  färgerna. För att se färgerna personligen,
                                  vänligen begär gratis prover.
                                </p>
                                <h3>Naturlig skönhet</h3>
                                <p>
                                  Våra produkter är designade för att se ut som
                                  naturligt trä och kan ha svag färg / textur
                                  och skuggnings variationer från bräde till
                                  bräda. Färg variationen påverkar inte på något
                                  sätt produktens prestanda.
                                </p>
                                <h3>Behåll skönheten</h3>
                                <p>
                                  Alla yttre ytor samlar smuts, damm och
                                  föroreningar och kräver rengöring. Det är
                                  nödvändigt att rengöra ditt komposit trall med
                                  jämna mellanrum för att hålla den så vacker
                                  som den dag du installerade det.
                                </p>
                              </div>
                            </div>
                            <div className="col-md-6 col-mobile-6 mb-40 mt-20 pl-30 pl-sm-15 pl-xs-15">
                              <div className="project-details">
                                ...
                                <ul>
                                  <li>
                                    ...
                                    dolda fästelement för att skapa enhetlig
                                    yta, vilket gör det säkrare och mer bekvämt
                                    för familjer med barn och husdjur.
                                  </li>
                                  <li>
                      ...
                      <div className="col-12 mb-20">
                        ...
                        <hr />
                        <p className="mb-40">
                          Green Plank SMART ™ -täcknings tillbehör utvidgar dina
                          horisonter ytterligare, så att du kan bygga ut
                          distinkta och förtjusande funktioner i ditt SMART ™
                          -trall som förbättrar både dess skönhet och
                          funktionalitet. Från F-trim och L-trim till stige
                          rörelser, ventilerade aluminium lister, trall pedaler,
                          balk, etc., här är alla trall delar du behöver för att
                          slutföra ditt SMART ™ trall projekt.
                        </p>
                      </div>
