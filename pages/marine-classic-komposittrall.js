...
import Image1 from "../assets/images/products/innerPages/Komposittrall/MarineCLASSIC.webp";

import Imagecolor1 from "../assets/images/colors/classicteak/american-walnut.webp";
import Imagecolor2 from "../assets/images/colors/classicteak/teak.webp";
...
<meta name="robots" content="index,follow" />
        <title>
          Marine Classic komposittrall | Marine Classic - GreenPlank.se
        </title>
        <meta
          name="title"
          content=" Marine Classic komposittrall |  Marine Classic - GreenPlank.se    "
        />
        <meta
          name="description"
          content="Green Plank’s Marine Classic komposittrall, Vårt Marine Classic komposittrall Beprövad nordisk kvalitetsträ för hårt väder. Classic™ kompositträ har varit det mest sålda trädäcket."
        />
    <link rel="canonical" href="https://www.greenplank.se/marine-classic-komposittrall" />
      </Head>
      <Layout pageTitle="marine-classic-komposittrall">
        <HeaderTwo />
        <StickyHeader />
        <PageHeader
          title="Marine-classic-komposittrall"
          crumb="Marine Classic Komposittrall"
          crumbTitle="Marine-classic-komposittrall"
        />
        <section className="blog-details pb-40 pt-40">
          <Container>
            <Row>
              <Col md={12} lg={12}>
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                          <div className="project-details">
                            <h2>Marine Classic Komposittrall</h2>
                            <strong>
                            ...
                            <div class="et_pb_text_inner">
                              <div class="ce_text block">
                                ...
                                <p>
                                  Med Green Plank Marine Classic komposittrall,
                                  du kan skapa ett utomhusutrymme perfekt för
                                  din stil som också är lätt att rengöra och ta
                                  hand om. Med ett så överraskande prisvärt
                                  alternativ finns det helt enkelt ingen
                                  anledning att nöja sig med att färga, täta,
                                  flisor och ständigt underhåll.
                                </p>
                                <p>
                                ...
                                <p>
                                  ...
                                  har vårt Marine Classic™ komposittrall varit
                                  den bästsäljande däckbrädan i mer än tio år
                                  ...
                                  <table width="100%">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left"> Marine-Classic</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                      ...
                                      <tr>
                                        ...
                                        <td align="left">Teak,Brazilain oak</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                          <strong>Yta :</strong>
