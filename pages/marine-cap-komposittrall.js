...
import PageHeader from "../components/page-header-MarineCap";
...
import Imagecolor1 from "../assets/images/colors/marine_cap/Baltic-Brown.webp";
import Imagecolor2 from "../assets/images/colors/marine_cap/Baltic-Grey.webp";
...
<meta name="robots" content="index,follow" />
        <title>
          MARINECAP™ komposittrall, perfekt trädäck för hemmet - Greenplank.se
        </title>
        <meta
          name="title"
          content="MARINECAP™ komposittrall, perfekt trädäck för hemmet - Greenplank.se"
        />
        <meta
          name="description"
          content="MARINECAP™ komposittrall är ingen vanlig trallbräda. Den revolutionerande 360º kapslings tekniken skyddar mot mögel, fukt och leriga vandringskängor."
        />
    <link rel="canonical" href="https://www.greenplank.se/marine-cap-komposittrall" />
      </Head>
      ...
      <Layout pageTitle="marine-cap-komposittrall">
        ...
        <StickyHeader />
        <PageHeader
          title="MARINECAP™ komposittrall med ytskikt av polymer"
          crumbTitle="MARINECAP™ komposittrall med ytskikt av polymer"
        />
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                          <div className="project-details">
                            <h2>
                              MARINECAP™ komposittrall med ytskikt av polymer
                            </h2>
                            <strong>Kvalitet är vår högsta prioritet</strong>
                            <div class="et_pb_text_inner">
                              <div class="ce_text block">
                                <strong>
                                  MARINE CAP™ inkapslade komposittrall står
                                  ovanför konkurrensen tack vare sin
                                  revolutionerande extruderingsprocess. Den
                                  samutpressade komposittekniken är inte bara
                                  fantastiskt realistisk utan håller också upp i
                                  några av de hårdaste klimat runt om i världen.
                                </strong>
                                <p>
                                  Green Planks MARINE CAP™ komposittrall med
                                  skyddande polymerlager är ingen vanlig
                                  komposittrall. Den revolutionerande
                                  360-graders tekniken skyddar mot mögel, fukt
                                  och leriga skor. Dessa toppmoderna
                                  co-extruderade kompositskivor är rep-, fläck-
                                  och varpbeständiga, vilket innebär att det
                                  orörda tillståndet i ditt lilla paradis
                                  bevaras. Djup trägravprägling för förbättrade
                                  glidbeständiga ytor möjliggör bra dragkraft i
                                  våta områden som runt pooler, de är säkra att
                                  gå på barfota.
                                </p>
                                <div>
                                  <ul>
                                    ...
                                    <li>
                                      ...
                                      Slutför din design av drömdäck på
                                      uteplatsen med våra täckbrädor – den
                                      perfekta matchen för ditt högpresterande
                                  ...
                                  <table width="100%">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left">
                                          Halkmotståndig, Träimpregnering,
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                        ...
                                        <td align="left">
                                          Komposit Trall solid cap,extra
                                          plastfilm på ytan
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td align="left">7,0 lm/m2</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                          <strong>Antal/St :</strong>
                                        </td>
                                        <td align="left">0,68 /m2</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                      ...
                                      <tr>
                                        ...
                                        <td align="left">4800 x 140 x 19 mm</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                ...
                                <div className="row mt-60">
                                  <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={8} sm={6} lg={6}>
                                      <a
                                        target="_blank"
                                        href="/pdfs/MarineCap/marine-capped-swedish-with-aluminum.pdf"
                                        className="thm-btn"
                                      >
