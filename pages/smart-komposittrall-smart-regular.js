...
const smartregular = () => {
  return (
    ...
    <Head>
        ...
        <meta name="description" content="Vårt Smart™ Regular™ komposittrall är inspirerad av naturliga mineraler och jord pigment, och föredras av husägare och arkitekter framför andra utegolv material." />
      </Head>
                        ...
                        <div className="project-details">
                          ...
                          <div class="et_pb_text_inner">
                            <div class="ce_text block">
                              ...
                              <strong>SMART™ komposittrall är ett utmärkt val för familjer på grund av det unika Not och Spont systemet och den gap fria ytan. Det är designat för maximal hållbarhet. Den motstår blekning, färgning, mögel och kommer inte att ruttna, spricka eller varpa. Den är också insekt säker och splintfri, vilket gör det säkrare och bekvämare för familjer med barn och husdjur.</strong>
                              Vårt Smart™ Regular™- trall är inspirerad av naturliga mineraler och jord pigment, med ett estetiskt tilltalande av kontinuerliga och texturerade spår, färg paletten är rik och livlig – och föredras av husägare och arkitekter framför andra utegolv material. Varje noggrant formulerade nyans innehåller attraktiva multi kromatiska toner och strimmiga. Smart™ Regular™ komposittrall skivor är säkra att gå på med bara fötter.
