...
import blogImg from "../assets/images/blog/Bamboo.webp";
...
const BambooGolv = () => {
  return (
    ...
    <Head>
        <title>För- och nackdelar med bambugolv. - Greenplank.se
</title>
        <meta name="title" content="För- och nackdelar med bambugolv. - Greenplank.se
" />
        <meta name="description" content="Bambugolv är ett underbart val. Bambu har en stark fuktbeständighet, vilket gör den idealisk för användning i badrum och andra våta miljöer. Bambugolv kan enkelt och rutinmässigt rengöras med en bambuspecifik golvmjölk eller andra rengöringsemulsioner.
" />
    <link rel="canonical" href="https://www.greenplank.se/bamboo-golv" />
      </Head>
    <Layout pageTitle="För- och nackdelar med bambugolv. - Greenplank.se">
      <HeaderTwo />
      <StickyHeader />
      <PageHeader title="Bamboo Golv" crumbTitle="bamboo golv" />
