...
const AboutOne = () => {
  return (
    <section className="about-one text-center pt-40 pb-40">
      <Container>
        ...
        <Row>
          ...
          <Col lg={6}>
            <div className="block-title">
              ...
              <h5>
                Han återvände till sitt hemland, Pakistan och började sitt arbete med att utveckla alternativ trä-produkt tillverkad av återvunnen plast och risskalfibrer.
              </h5>
              <h5>
