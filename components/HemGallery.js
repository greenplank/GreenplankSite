                ...
                <Row>
                    <Col xl={12}>
                        ...
                        <div className="text-center block-title ">
                            <h1>Green Plank<span style="vertical-align:2.7em; font-size:0.2em;">&reg;</span> komposittrall produkter</h1>
                        </div>
                    </Col>
                </Row>
                <Row>
                            ...
                            <Col md={6} xs={6}>
                                <a href="smart-komposittrall-smart-cap">
                                    <div className="mt-10 mb-10">
                                        ...
                                        <div className="service-two__box-inner text-center">
                                            <h3 className="title" style={{ color: "white" }}><b>SmartCap™</b></h3>
                                        </div>
                                    </div>
                                </a>
                            </Col>
                            ...
                            <Col md={6} xs={6}>
                                <a href="entra-trall">
                                    <div className="mb-20 mt-20">
                                        ...
                                        <div className="service-two__box-inner">
                                            <h3 className="title" style={{ color: "white" }}><b>Entra™ Komposittrall</b></h3>
                                        </div>
                                    </div>
                                </a>
                            </Col>
