...
import banner3 from "../../assets/images/main-slider/slider31.webp";
        ...
        <div className="col-lg-3 p-0">
          ...
          >
            <div>
              ...
              >
                Topp svensk varumärke för innovativa komposittrall,
                fasadbeklädnad & staket med träkänsla, hållbarhet & design i
                fokus!
              </h2>
              <Grid container spacing={3}>
                <Grid item xs={6} sm={6}>
                  <a
                    ...
                    className="thm-btn thm-btn2 rounded-pill"
                  >
              ...
              <Grid container spacing={3}>
                <Grid item xs={6} sm={6}>
                  <a
                    ...
                    href="smart-komposittrall"
                    className="thm-btn thm-btn2 rounded-pill"
                  >
                    <center>Smart komposittrall</center>
                  </a>
                </Grid>
                <Grid item xs={6} sm={6}>
                  <a
                      ...
                      <section style={{ marginTop: "-8em" }}>
                        <div>
                          <div className="block-title text-left">
                            <h3>
                              <span
                                style={{ color: "white", fontSize: "76px" }}
                              >
                                Green Plank<sup>&reg;</sup>
                              </span>
                            </h3>
                          </div>
                          <h2
                          ...
                          >
                            Topp svensk varumärke för innovativa komposittrall,
                            fasadbeklädnad & staket med träkänsla, hållbarhet &
                            design i fokus!
                          </h2>
                          <Grid container spacing={3}>
                            <Grid item xs={6} sm={6}>
                              <a
                                ...
                                href="http://deckplanner.greenplank.eu/"
                                className="thm-btn thm-btn3 rounded-pill"
                              >
                                <center>Trall Planerare</center>
                              </a>
                            </Grid>
                          ...
                          <Grid container spacing={3}>
                            ...
                            <Grid item xs={6} sm={6}>
                              <a
                                ...
                                href="https://deckplanner.greenplank.eu/"
                                className="thm-btn thm-btn3 rounded-pill"
                              >
                                Trall Planerare
                              </a>
